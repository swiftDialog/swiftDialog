...
struct JHOptions {
    static let windowType         = (long: String("windowType"),       short: String("windowType"),         matchingCLO: String("")) // -windowType [hud | utility | fs]
    static let windowPosition     = (long: String("windowPosition"),   short: String("windowPosition"),     matchingCLO: String("")) // -windowPosition [ul | ll | ur | lr]
    static let title              = (long: String("title"),            short: String("title"),              matchingCLO: String("")) // -title "string"
    static let heading            = (long: String("heading"),          short: String("heading"),            matchingCLO: String("")) // -heading "string"
    static let description        = (long: String("description"),      short: String("description"),        matchingCLO: String("")) // -description "string"
    static let icon               = (long: String("icon"),             short: String("icon"),               matchingCLO: String("")) // -icon path
    static let button1            = (long: String("button1"),          short: String("button1"),            matchingCLO: String("")) // -button1 "string"
    static let button2            = (long: String("button2"),          short: String("button2"),            matchingCLO: String("")) // -button2 "string"
    static let defaultButton      = (long: String("defaultButton"),    short: String("defaultButton"),      matchingCLO: String("")) // -defaultButton [1 | 2]
    static let cancelButton       = (long: String("cancelButton"),     short: String("cancelButton"),       matchingCLO: String("")) // -cancelButton [1 | 2]
    static let showDelayOptions   = (long: String("showDelayOptions"), short: String("showDelayOptions"),   matchingCLO: String("")) // -showDelayOptions "int, int, int,..."
    static let alignDescription   = (long: String("alignDescription"), short: String("alignDescription"),   matchingCLO: String("")) // -alignDescription [right | left | center | justified | natural]
    static let alignHeading       = (long: String("alignHeading"),     short: String("alignHeading"),       matchingCLO: String("")) // -alignHeading [right | left | center | justified | natural]
    static let alignCountdown     = (long: String("alignCountdown"),   short: String("alignCountdown"),     matchingCLO: String("")) // -alignCountdown [right | left | center | justified | natural]
    static let timeout            = (long: String("timeout"),          short: String("timeout"),            matchingCLO: String("")) // -timeout int
    static let countdown          = (long: String("countdown"),        short: String("countdown"),          matchingCLO: String("")) // -countdown
    static let iconSize           = (long: String("iconSize"),         short: String("iconSize"),           matchingCLO: String("")) // -iconSize pixels
    static let lockHUD            = (long: String("lockHUD"),          short: String("lockHUD"),            matchingCLO: String("")) // -lockHUD
    static let fullScreenIcon     = (long: String("fullScreenIcon"),   short: String("fullScreenIcon"),     matchingCLO: String("")) // -fullScreenIcon
