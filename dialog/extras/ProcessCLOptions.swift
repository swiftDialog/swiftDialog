    ...
    if cloptions.textField.present {
        if json[cloptions.textField.long].exists() {
            ...
            for textFieldOption in CLOptionMultiOptions(optionName: cloptions.textField.long) {
                ...
                textFields.append(TextFieldState(title: fieldTitle, required: fieldRequire, secure: fieldSecure, passwordfill: fieldPasswordFill, prompt: fieldPrompt, regex: fieldRegex, regexError: fieldRegexErrror))
            }
        }
